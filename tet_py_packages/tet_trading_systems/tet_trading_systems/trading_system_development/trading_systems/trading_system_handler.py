...
class TradingSystemsHandler:
    ...
    def _run_trading_systems(self, date: dt.datetime, full_run: bool):
    ...
    def __call__(self, date: dt.datetime, full_run: bool):
        self._run_trading_systems(date, full_run)
