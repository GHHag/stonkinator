...
func register(port string, api_url string) {
	...
	http.HandleFunc(fmt.Sprintf("%s/exchange", api_url), )
	http.HandleFunc(fmt.Sprintf("%s/instrument", api_url), )
	http.HandleFunc(fmt.Sprintf("%s/price-data", api_url), )

	http.HandleFunc(fmt.Sprintf("%s/first-dt", api_url), )
	http.HandleFunc(fmt.Sprintf("%s/last-dt", api_url), )
	http.HandleFunc(fmt.Sprintf("%s/date", api_url), )
