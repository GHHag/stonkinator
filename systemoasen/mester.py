...
def get_mean_reversion_stocks_props(instruments_db: InstrumentsMongoDb):
    ...
    return TradingSystemProperties(
        ...
        #(
        #    system_name, 
        #    MetricRankingPortfolioCreator(), 
        #    AvanzaOrderExecutionHandler()
        #),
        #(None, None)
        {
...
if __name__ == '__main__':
    ...
    system_props = get_mean_reversion_stocks_props(INSTRUMENTS_DB)
